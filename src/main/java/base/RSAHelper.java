...
public class RSAHelper {
    public static final String PUBLIC_KEY_VALUES = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCoPDrTGRLzHW02Sp7FFLM+vS4KvGy3nLpipaS8iKWFpdBdT5sgUrm16ZztRyBVhdYwSds3vdIJNZtrBY6R0n+IJe3q4elhh+dw4Yw7FmxDRD5CqK/cx54oUPM4fL1X6aIN1jOHYtKjT2LAMoO/8s6s29dPfwoQmNLdkrEWoEtmMwIDAQAB";
    ...
    public static void main(String[] args) {
        String str = "{\n" +
                ...
                "    \"content\":\"【huobi】火币中网信测试。。。。。\",\n" +
                "    \"sendTime\":\"\"\n" +
                "}";
        System.out.println(encipher(str,PUBLIC_KEY_VALUES,8));
    }
